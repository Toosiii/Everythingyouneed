...
const BASE=(()=>{const u=location.href.split('?')[0];return u.substring(0,u.lastIndexOf('/')+1);})();
...
async function loadData() {
    try {
        ...
        document.body.innerHTML = '<div style="padding:2rem;color:red;font-family:sans-serif;text-align:center;">⚠️ <b>Daten konnten nicht geladen werden.</b><br>Bitte stelle sicher, dass du einen lokalen Server nutzt (z.B. Live Server in VS Code) und kein file:/// in der Adresszeile steht.</div>';
        return;
    }
